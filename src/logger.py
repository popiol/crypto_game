...
class Logger:
    ...
    def log_portfolios(self, agents: list[Agent], portfolios: list[Portfolio]):
        if self.log_portfolio_iter % self.log_portfolio_once_per == 0:
            ...
            columns = [a.agent_name for a in agents]
